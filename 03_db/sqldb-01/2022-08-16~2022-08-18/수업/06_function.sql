...
SELECT last_name || first_name, age, country, phone, balance FROM users  LIMIT 5;

last_name || first_name  age  country  phone          balance
-----------------------  ---  -------  -------------  -------
...
SELECT first_name, phone, REPLACE(phone, '-', '') AS phone FROM users LIMIT 5;
